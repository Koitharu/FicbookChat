...
public class ExpandableTextLayout extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = ThemeUtils.getThemedDrawable(getContext(), R.drawable.ic_expand_more_black_24dp, ChatApp.getApplicationPalette().getContrastColor());
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = ThemeUtils.getThemedDrawable(getContext(), R.drawable.ic_expand_less_black_24dp, ChatApp.getApplicationPalette().getContrastColor());
        }
